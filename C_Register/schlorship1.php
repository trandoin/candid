...
<?php Confirm_passwordschs(); ?>

<?php 

    $SchID =   $_SESSION["ShUserId"];
    $SchUName =   $_SESSION["ShUsername"];
    $SchName =   $_SESSION["ShName"];
    $SchMobile =   $_SESSION["ShMobile"];
    $ShClass =   $_SESSION["ShClass"];
    $SchStream =   $_SESSION["ShStream"];
    $SchGender =   $_SESSION["ShGender"];                                                                                                                                                                                                                                                     
?>
   ...
   font-size:18px;
    ...
    <body>
        ...
        <div class="container box">
            <br />
            <h1 class="text-center"> <i class="fas fa-user"></i> Candid Scholarship Registration Form</h1> <hr style="border-bottom:4px solid grey;border-left:4px solid transparent;border-right:4px solid transparent;">
           <!-- <?php echo $message; ?> -->
            ...
            <form method="post" id="register_form" action="success.php" enctype="multipart/form-data">
        ...
        <div class="panel panel-default">
         ...
         <div class="panel-body">
          ...
          <div class="form-group">
              ...
              <input type="text" name="sname" id="name" style="cursor: not-allowed;" value="<?php echo $SchName; ?>" placeholder="Enter your name" class="form-control input-lg" />
              <span id="error_name" class="text-danger"></span>
             </div>
          <div class="form-group">
           <label>Your Email </label>
           <input type="email" name="email" id="email" style="cursor: not-allowed;" value="<?php echo $SchUName; ?>" placeholder="Enter your email" class="form-control input-lg" />
          ...
          <div class="form-group">
           ...
           <input  type="number" id="phone" style="cursor: not-allowed;" name="sphone" value="<?php echo $SchMobile; ?>" class="form-control input-lg" placeholder="Enter your phone Number">
