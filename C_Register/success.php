...
if (isset($_POST['Register'])) {
  ...
  if (empty($Name)) {
    ...
    $sql = "INSERT INTO c_r_p_u(datetime,name,gender,mobile,email,dob,category,country,adhar,fname,foccupation,fmobile,mname,moccupation,mmobile,paddress,ppincity,pdistrict,caddress,cpincity,cdistrict,stream,pclass,board,medium,admissionclass,schoolname,schooladdress,photo,markssheet10th,markssheet12th,source,terms)";
    $sql .= "VALUES(:dateTime,:NamE,:GendeR,:MobilE,:EmaiL,:Dob,:CategorY,:CountrY,:AddaR,:FnamE,:foccupatioN,:Fmobile,:MnamE,:MoccupaTioN,:Mmobile,:PaddresS,:PPincitY,:PdistricT,:CAddreSS,:CPinCity,:CDistRict,:Stream,:PcLLass,:Board,:MediUm,:AClass,:SchoolName,:SchoolAdd,:PhOto,:markSheet10th,:markSheet12th,:SoUrce,:terms)";
