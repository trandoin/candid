         ...
         $('#previous_btn_personal_details').click(function(){
          ...
          $('#your_details').addClass('active in');
                 ...
                 $('#btn_address_details').click(function(){
                       ...
                       var error_saddress = '';
                       var error_medium = '';
                       var error_status12th = '';
                       var error_status10th = '';
...
// appear in 10th
                                          ...
                                          if($.trim($('#status10th').val()).length == 0)
                                          {
                                           error_status10th = 'It is required';
                                           $('#error_status10th').text(error_status10th);
                                           $('#status10th').addClass('has-error');
                                          }
                                          else
                                          {
                                           error_status10th = '';
                                           $('#error_status10th').text(error_status10th);
                                           $('#status10th').removeClass('has-error');
                                          }

// appear in 12th

                                          if($.trim($('#status12th').val()).length == 0)
                                          {
                                           error_status12th = 'It is required';
                                           $('#error_status12th').text(error_status12th);
                                           $('#status12th').addClass('has-error');
                                          }
                                          else
                                          {
                                           error_status12th = '';
                                           $('#error_status12th').text(error_status12th);
                                           $('#status12th').removeClass('has-error');
                                          }
                                          
                                          
                                          
                                          if(error_stream != ''|| error_status12th != '' || error_status10th !='' || error_class != '' || error_board != '' || error_Aclass != ''|| error_school != '' || error_saddress != ''  || error_medium != '')
                                          {
                                           return false;
                                          }
                                          else
