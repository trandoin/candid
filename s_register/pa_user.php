...
if (isset($_POST['PRegister'])) {
  ...
  $ConfirmPassword = $_POST['pcpassword'];
 ...
 // $IMAGE = $_FILES['Image']['name'];
  ...
  elseif (PCheckUserNameExistOrNot($Name,$Email)) {
    ...
    $sql = "INSERT INTO p_user(datetime,name,email,mobile,gender,stream,class,password)";
    ...
    $stmt->bindValue(':PassworD', $Password);
      ...
      if ($Execute) {
          ...
          Redirect_to("../Varification/"); // You Can Send Admin to Any PAge YOU Want
        }else{
...
if (isset($_POST['PLogin'])) {
  ...
  if (empty($UserName)||empty($Password)) {
    ...
    $Found_Account=PLogin_Attampt($UserName,$Password);
    if ($Found_Account) {
    
           $_SESSION["PUserId"]= $Found_Account["id"];
           $_SESSION["PUsername"]= $Found_Account["email"];
           $_SESSION["PPassword"]= $Found_Account["password"];
           $_SESSION['PName']= $Found_Account["name"];
           $_SESSION["PSGender"] = $Found_Account["gender"];
           $_SESSION["PSMobile"] = $Found_Account["mobile"];
           $_SESSION["PSStream"] = $Found_Account["stream"];
           $_SESSION["PSClass"] = $Found_Account["class"];
      $_SESSION["SuccessMessage"] = "Welcome " .$_SESSION["PName"]. "!";
      Redirect_to("../C_Register/");
    }else{
...
<head>
    ...
    <title>Candid | paid user Sign Up</title>
    ...
    <div class="container mt-5">
        ...
        <div class="card">
            <div class="card-header text-center">
               <h5><i class="sign-in-alt"></i> Paid Student Login</h5>
            </div>
            <?php 
                  echo ErrorMessage();
                  echo SuccessMessage(); 
       ...
       ?>
            <div class="card-body">
                ...
                <div class="panel-body">
                    <form action="pa_user.php" method="post" class=""  >
                 <div class="form-group">
                   <div class="input-group">
                    <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-user" style="font-size: 24px;" aria-hidden="true"></i></span></div>
                     <input placeholder="Enter reistered email id...."  type="text" name="pusername" id="name" class="form-control" />
                     </div>
                    </div>
                    <div class="form-group">
                  <div class="input-group">
                    <div class="input-group-prepend"><span class="input-group-text"><i class="fa fa-lock" style="font-size: 24px;" aria-hidden="true"></i></span></div>
                     <input placeholder="Enter password..." type="password" name="ppassword" id="myInput" class="form-control" />
                     </div>
                    </div>
                    <input type="checkbox" onclick="myFunction()"> &nbsp;Show Password
                   <div class="text-center">
                    <button type="submit"  name="PLogin" class="btn btn-primary">LOGIN</button>
                   </div>
                    </form>
          ...
          <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                                  ...
                                  <div class="card">
                                      <div class="card-header text-center"><h5>Paid Student Register</h5></div>
                                      <?php 
                  echo ErrorMessage();
                  echo SuccessMessage(); 
       ...
       ?>
                                      <div class="card-body">
                                        <form action="pa_user.php" method="post" class=""  >
                                            <div class="form-group">
                                                <input placeholder="Enter Your Name..." type="text" name="pname" id="name" class="form-control" />
                                               </div>
                                            <div class="form-group">
                                           
                                             <input type="email" placeholder="Enter Your Email..." name="pemail" id="email" class="form-control" />
                                             
                                            </div>
                                            <div class="form-group">
                                                
                                                <input type="number" placeholder="Enter Your Phone..." name="pphone" id="phone" class="form-control" />
                                                
                                               </div>
                                               <div class="form-group">
                                            
                                               <select class="form-control"  id="category" size="1" name="pgender">
                                               ...
                                               <select class="form-control"  id="category" size="1" name="pstram">
                                               ...
                                               <select class="form-control"  id="category" size="1" name="pclass">
                                               ...
                                               <div class="form-group">
                                                   ...
                                                   <input class="form-control " type="password" name="ppassword" placeholder="Enter Your password..." value="" >
                                              
                                              </div>
                                               <div class="form-group">
                                                
                                           
                                                   <input class="form-control " type="password" name="pcpassword" placeholder="Re-Enter Your Password..." value="" >
                                             
                                              </div>
                                               <div align="center"><br>
                                                   <button type="submit"  name="PRegister" class="btn btn-primary">Sign Up</button>
                                                  </div>
