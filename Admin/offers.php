...
if (isset($_POST['Submit'])) {
	...
	elseif (strlen($POSTTEXT)>9999) {
		...
		$sql = "INSERT INTO offer(datetime,category,author,title,description,image)";
		$sql .= "VALUES(:dateTime,:categoriesName,:adminName,:postTitle,:postDescription,:imageName)";
      ...
      if ($Execute) {
        	...
        	Redirect_to("offers.php"); // You Can Send Admin to Any PAge YOU Want
        }else{
...
<head>
	...
	<title>Add New Offer Post</title>
</head>
<body>
	<!--HEADER START -->
	...
	<div class="row">
		<div class="offset-lg-1 col-lg-10" style="min-height: 440px;">
			...
			<?php 
			 ...
			 ?>
			<form action="offers.php" method="post" enctype="multipart/form-data">  <!--  Here we using enctype in form this use for handle images in database table   -->
				<div class="card bg-secondary text-light mb-3">
					<div class="card-body bg-dark">
						<h1><i class="fas fa-edit" style="color: #27aae1;"></i>Add New Offer Post</h1>
						<div class="form-group">
							<label for="title"> <span class="Fieldinfo">Offer Title</span></label>
						...
						<div class="form-group">
							<label for="Post"> <span class="Fieldinfo">Offer Description</span></label>
			...
			<table class="table">
				...
				<?php 
				 ...
				 <tr>
				 	...
				 	<td>
                    <a href="Doffers.php?id=<?php echo $Id; ?>"><span class="btn btn-danger">Delete</span></a>
				 	</td>
				 	<!--
