...
if (isset($_POST['Submit'])) {
	...
	if (empty($POSTTITLE)||empty($IMAGE)) {
		...
		Redirect_to("board_paper.php");
	}
	else{

		#Query to insert post in DB when everything is fine
		global $ConnectingDB; // FOR OLD VERSION OF PHP LIKE 5.6 ect
		$sql = "INSERT INTO board_p(datetime,category,author,title,pdf)";
      ...
      if ($Execute) {
        	...
        	Redirect_to("board_paper.php"); // You Can Send Admin to Any PAge YOU Want
        }else{
...
<head>
	...
	<title>Add New Board Paper</title>
</head>
<body>
	<!--HEADER START -->
	...
	<div class="row">
		<div class="offset-lg-1 col-lg-10" style="min-height: 440px;">
			...
			<?php 
			 ...
			 ?>
			<form action="board_paper.php" method="post" enctype="multipart/form-data">  <!--  Here we using enctype in form this use for handle images in database table   -->
				<div class="card bg-secondary text-light mb-3">
					<div class="card-body bg-dark">
						<h1><i class="fas fa-edit" style="color: #27aae1;"></i>Add New Board Paper</h1>
			...
			<table class="table">
				...
				<?php 
				 ...
				 <tr>
				 	...
				 	<td>
                    <a href="Dboard_p.php?id=<?php echo $Id; ?>"><span class="btn btn-danger">Delete</span></a>
				 	</td>
				 </tr>
				 </tbody>
				<?php } ?>
