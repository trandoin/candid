...
if (isset($_POST['Submit'])) {
	...
	elseif (strlen($PostTitle)<5) {
		...
		$sql = "INSERT INTO ne(datetime,title,pdf)";
        ...
        if ($Execute) {
        	...
        	Redirect_to("NE.php"); // You Can Send Admin to Any PAge YOU Want
        }else{
	...
	<div class="row">
	    <div class="col-lg-12">	
			<?php 
			 ...
			 ?>
			<form action="NE.php" method="post" enctype="multipart/form-data">  <!--  Here we using enctype in form this use for handle images in database table   -->
				<div class="card bg-secondary text-light mb-3">
					<div class="card-body bg-dark">
						<div class="form-group">
							<label for="title"> <span class="Fieldinfo">News & Events Title</span></label>
			...
			<table class="table">
				...
				<?php 
				 ...
				 <tr>
				 	...
				 	<td>
                    <a href="DNE.php?id=<?php echo $Id; ?>"><span class="btn btn-danger">Delete</span></a>
				 	</td> 
				 	<!--
