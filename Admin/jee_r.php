...
if (isset($_POST['Submit'])) {
	...
	if (empty($StudentName)||empty($CATEGORY)||empty($IMAGE)) {
		...
		$sql = "INSERT INTO jee_r(datetime,author,category,sname,main,adv,image,program)";
      ...
      if ($Execute) {
        	...
        	Redirect_to("jee_r.php"); // You Can Send Admin to Any PAge YOU Want
        }else{
...
<head>
	...
	<title>Add New Jee Results</title>
</head>
<body>
	<!--HEADER START -->
	...
	<div class="row">
		<div class="offset-lg-1 col-lg-10" style="min-height: 440px;">
			...
			<?php 
			 ...
			 ?>
			<form action="jee_r.php" method="post" enctype="multipart/form-data">  <!--  Here we using enctype in form this use for handle images in database table   -->
				<div class="card bg-secondary text-light mb-3">
					<div class="card-body bg-dark">
						<h1><i class="fas fa-edit" style="color: #27aae1;"></i>Add New Jee Results</h1>
						...
						<div class="form-group">
							<label for="title1"> <span class="Fieldinfo">Jee Main Rank</span></label>
							<input class="form-control" type="text" name="MRank" id="title1" value="" placeholder="Type Jee main Rank here">
						</div>
						<div class="form-group">
							<label for="title2"> <span class="Fieldinfo">Jee Advance Rank</span></label>
							<input class="form-control" type="text" name="ARank" id="title2" value="" placeholder="Type Jee Advance Rank here">
						</div>
						<div class="form-group">
		...
		<div class="col-lg-12">
			...
			<table class="table">
				...
				<?php 
				 ...
				 <td>
                    <a href="Djee_r.php?id=<?php echo $Id; ?>"><span class="btn btn-danger">Delete</span></a>
				 	</td>
				 </tr>
				 </tbody>
				<?php } ?>
